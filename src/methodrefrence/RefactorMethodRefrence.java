...
public class RefactorMethodRefrence {
    ...
    static Predicate<Student> predicateUsingMetRef = RefactorMethodRefrence::greaterThan;


    static BiPredicate<Student,Integer> predicateUsingMethodReference = RefactorMethodRefrence::greaterThan;

...
public class Example1 {
    ...
    public static void main(String[] args) {
        ...
        long sequentialDuration = checkPerformanceResult(Example1::sum_sequential_stream,20);
        ...
        long parallelDuration =checkPerformanceResult(Example1::sum_parallel_stream,20);
